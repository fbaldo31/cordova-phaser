var Player = function(game, x, y, target, id) {
  this.id = id;
  if (target) {
...
Player.prototype.onUpdateFromServer = function(data) {
...
Player.prototype.updateHero = function() {
...
Player.prototype.updateRemote = function() {
...
Player.prototype.die = function(autoKill){
  if(!this.dead){
    this.dead = true;
    this.alpha = 0;
...
Player.prototype.wasHitBy = function(bullet, player) {
  if (!this.shieldsEnabled) {
    this.health -= 10;
...
Player.prototype.showExplosion = function() {
...
Player.prototype.enableShield = function(duration) {
