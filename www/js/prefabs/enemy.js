  var Enemy = function(game, x, y, desc, target){
  ...
  Enemy.prototype.die = function(autoKill){
    if(!this.dead){
      this.dead = true;
      this.alpha = 0;
  ...
  Enemy.prototype.reload = function(i, from){
  ...
  Enemy.prototype.resetTarget = function(to){
